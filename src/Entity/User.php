 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre compte possède déjà cette adresse ! Merci d'en choisir une autre "
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Veuillez donner une adresse URL valide pour votre avatar")
     */
    private $picture;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Vous n'avez pas corectement confirmer votre mot de passe")
     */
